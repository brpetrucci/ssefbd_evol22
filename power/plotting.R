...
base_dir <- "/Users/petrucci/Documents/research/ssefbd_evol22/power/analysis/output"

# mod-fbd
mod_dir <- "fbd"

# get logs (cut 6 - organizational cols, likelihoods, and div)
fbd_logs <- read_logs(refs, nReps, base_dir, mod_dir, 6)[[1]]
...
ggplot(modes[[1]], aes(x = psi, y = div)) +
  geom_point() + geom_hline(yintercept = 0.07) + geom_vline(xintercept = 0.05)
